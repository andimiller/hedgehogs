...
trait Graphviz extends js.Object {
  ...
  def neato(dotSource: String, outputFormat: String): String = js.native
  def fdp(dotSource: String, outputFormat: String): String = js.native
  def sfdp(dotSource: String, outputFormat: String): String = js.native
  def circo(dotSource: String, outputFormat: String): String = js.native
}
